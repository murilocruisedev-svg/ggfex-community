...
export function Header({ onOpenMobileMenu }: HeaderProps) {
    ...
    const handleSearch = useCallback((value: string) => {
        ...
        // Debounce-like: navigate on each change
    ...
    return (
        <header className="sticky top-0 z-40 bg-[#050505]/90 backdrop-blur-md border-b border-white/5 h-16 flex items-center justify-center gap-4 px-4 md:px-6 transition-all">
