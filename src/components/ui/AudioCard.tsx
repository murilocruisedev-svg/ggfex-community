...
export function AudioCard({ sound, isLocked = false }: AudioCardProps) {
    ...
    return (
        <div
            className="group relative bg-[#161616] border border-white/5 rounded-2xl p-4 md:p-5 transition-all duration-300 hover:bg-[#1A1A1A] hover:border-[#F24405]/50 hover:shadow-[0_0_30px_rgba(242,68,5,0.15)] flex flex-col justify-between h-full overflow-hidden active:scale-[0.98] md:active:scale-100 mobile-tap-highlight-none"
        ...
        >
            ...
            <audio
                ...
                preload="none"
                controlsList="nodownload" // Dificulta download direto no player nativo
            ...
            <div className="relative z-10 flex items-start justify-between mb-3 md:mb-4">
                ...
                <div className="p-2 bg-black/20 rounded-full text-gray-400 group-hover:bg-[#F24405] group-hover:text-white transition-colors duration-300 flex-shrink-0">
                    <Volume2 className="w-4 h-4 md:w-5 md:h-5" />
                </div>
            </div>

            {/* Visualizer Premium */}
            <div className="relative z-10 h-20 md:h-24 bg-[#0A0A0A] rounded-xl mb-4 flex items-center justify-center overflow-hidden border border-white/5 group-hover:border-[#F24405]/30 transition-colors shadow-inner">
            ...
            <div className="relative z-10 flex items-center justify-between mt-auto pt-4 border-t border-white/5 group-hover:border-white/10">
                ...
                {isLocked ? (
                    <button
                        ...
                        className="flex-shrink-0 flex items-center space-x-2 px-3 py-2 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-500 transition-all text-xs font-bold border border-red-500/20 ml-2 cursor-pointer"
                        title="Conteúdo bloqueado para não-assinantes"
                    >
