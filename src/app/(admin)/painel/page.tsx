...
export default function AdminDashboardPage() {
    return (
        <div className="space-y-8">
            ...
            {/* 1. Header de Boas vindas */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-white/5 pb-6 md:pb-8 gap-4 md:gap-0">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight">Dashboard</h1>
                    <p className="text-gray-400 mt-2 text-base md:text-lg">Visão geral do desempenho da sua comunidade. 🚀</p>
                </div>
